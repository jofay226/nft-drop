    ...
    <div className='flex h-screen flex-col lg:grid lg:grid-cols-10'>
        ...
        <div className=' lg:col-span-4 bg-gradient-to-br from-cyan-800 to-rose-500'>
            <div className='flex flex-col items-center justify-center py-2 lg:min-h-screen'>
                ...
                <div className=' space-y-2 text-center p-5'>
                    <h1 className='text-4xl font-bold text-white'>JoFaY Apes</h1>
                    <h2 className='text-xl text-gray-300'>A collection of JoFaY Apes who live & breathe React!</h2>
                </div>
            </div>
        </div>
        ...
        <div className='flex flex-1 flex-col p-12 lg:col-span-6'>
            ...
            <header className='flex items-center justify-between'>
                <h1 className='w-52 cursor-pointer text-xl font-extralight sm:w-80'> The {' '}<span className='font-extrabold underline decoration-pink-600/50'> JoFaY </span> {' '}   NFT Market Place </h1>
            ...
            <div className='mt-10 flex flex-1 flex-col items-center space-y-6 text-center lg:space-y-0 lg:justify-center'>
                ...
                <h1 className='text-3xl font-bold lg:text-5xl lg:font-extrabold'>The JoFaY Ape Coding Club | NFT Drop</h1>
